...
import uy.gub.imm.spring.component.AuthEntryPointJwt;
import uy.gub.imm.spring.filter.AuthenticationTokenFilter;
...
public class ConfiguracionDeSeguridad extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private ServicioUsuarioImpl userDetails;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.exceptionHandling()
		.authenticationEntryPoint(entryPointFault).and()
